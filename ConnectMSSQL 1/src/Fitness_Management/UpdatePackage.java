...
public class UpdatePackage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("UPDATE Packages");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            ResultSet rs = st.executeQuery("SELECT MemberId,CustomerName,PackageStatus FROM PACKAGEINFO where MemberId='"+MemberId+"'");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        {
            Connection con=ConnectionProvider.getCon();
            PreparedStatement ps = con.prepareStatement("update PACKAGEINFO set CustomerName=?, PackageStatus=?, PackagePrice=? where MemberId=?" );
       ...
       int a=JOptionPane.showConfirmDialog(null,"Are you Sure?","Select",JOptionPane.YES_NO_OPTION);
        if(a==0)
        {
            ...
            try
            {
                Connection con = ConnectionProvider.getCon();
                Statement st=con.createStatement();
                st.executeUpdate("delete from PACKAGEINFO where MemberId='"+MemberId+"'");
